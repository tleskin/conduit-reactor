...
describe Activate do
  let(:port_attributes) do
    credentials.merge(nid: '111222333444555667', zip: '33413', carrier_name: 'Sprint',
                      subscriber_uuid: "edfd286c-316f-40ad-bb8a-7f8f889bc6ca", company_uuid: "adfd286c-316f-40ad-bb8a-7f8f889bc6ca",
  ...
  let(:activate_port_request) do
    File.read('./spec/fixtures/requests/activate/activate_port.json').chomp
  end
