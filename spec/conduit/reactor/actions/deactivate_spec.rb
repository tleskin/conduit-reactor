...
describe Deactivate do
  ...
  let(:deactivate_line) do
    described_class.new(creds)
  end

  let(:deactivate_line_request) do
    File.read('./spec/fixtures/requests/deactivate_line/request.json')
  end

  describe 'deactivate_line_request_json' do
    subject { deactivate_line.view }
    it      { should eq deactivate_line_request }
  end
